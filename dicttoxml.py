...
if __name__ == "__main__":
    ...
    # sample_json['xml_root'] = xml_root

    # obj = DictToXML(
    #     dictionary=sample_json,
    #     xml_version="1.0",
    #     encoding="utf-8",
    #     root_name="FIXML",
    #     root_attributes=xml_root['root_attributes']
    # )
    # # print(obj.get_prolog())
    # output = obj.get_xml(prolog=True)
